  ...
  return (
    <div className="page">
      ...
      <aside className="sidebar">
        <div className="logo">Tool TikTok</div>

        <button className="upload-btn">+ Tải lên</button>

        <div className="menu active">Trang chủ</div>
        <div className="menu">Bài đăng</div>
        <div className="menu">Phân tích</div>
        <div className="menu">Bình luận</div>
        <div className="menu">Cảm hứng</div>
      </aside>
